...
async function tPacket_NMatchup_NChannel_SN_ServerList(socket, sequence) {
    const packet = IDefaultGamePacket.init(sequence, PACKET_TYPES.SN_ServerList);
    ...
    console.log("tPacket_NMatchup_NChannel_SN_ServerList Paketi Gönderildi");
}

module.exports = tPacket_NMatchup_NChannel_SN_ServerList;
